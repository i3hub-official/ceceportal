  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center max-w-xs">
        ...
        {/* Progress Bar */}
        <div className="w-full bg-muted-10 dark:bg-muted-20 rounded-full h-2 mb-6 overflow-hidden">
          <div className="bg-gradient-to-r from-primary to-primary-70 h-full rounded-full animate-loading-bar"></div>
        </div>
